...
public class GPSTracker extends Service implements LocationListener {
	...
	public void showInvalidLocationAlert(){

		final AlertDialog.Builder alertDialog = new AlertDialog.Builder(mContext);
		alertDialog.setTitle("We can't get your location!");
		alertDialog.setCancelable(false);
		alertDialog.setMessage("We can't predict your location,please make sure GPS is in ON. or try again");
