...
import com.uactiv.interfaces.Corner;
...
public class RoundedDrawable extends Drawable {
  ...
  //used to return Drawable from bitmap of type RoundedDrawable
  ...
  //used to return Drawable from drawable of type RoundedDrawable
  ...
  //used to return bitmap from drawable
  ...
  //used to update the shader matrix through the params return by RoundedDrawable
  ...
  //will draw using canvas through bitmaps
  @Override
  ...
  //used to redraw the bitmap with square borders
