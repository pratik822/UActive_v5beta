 ...
 */
public class CircularImageViews extends ImageView {
    ...
    public CircularImageViews(final Context context) {
        this(context, null);
    }

    public CircularImageViews(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircularImageViews(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.CircularImageViews, defStyleAttr, 0);

        // Init Border
        if (attributes.getBoolean(R.styleable.CircularImageViews_civ_border, true)) {
            float defaultBorderSize = DEFAULT_BORDER_WIDTH * getContext().getResources().getDisplayMetrics().density;
            setBorderWidth(attributes.getDimension(R.styleable.CircularImageViews_civ_border_width, defaultBorderSize));
            setBorderColor(attributes.getColor(R.styleable.CircularImageViews_civ_border_color, Color.WHITE));
        }

        // Init Shadow
        if (attributes.getBoolean(R.styleable.CircularImageViews_civ_shadow, false)) {
            shadowRadius = DEFAULT_SHADOW_RADIUS;
            drawShadow(attributes.getFloat(R.styleable.CircularImageViews_civ_shadow_radius, shadowRadius), attributes.getColor(R.styleable.CircularImageViews_civ_shadow_color, shadowColor));
        }
    }
    //endregion
