...
import com.uactiv.R;
import com.uactiv.activity.getback;
import com.uactiv.adapter.PastNotificationHeaderAdapter;
...
public class Pastnotifiationfragment extends Fragment implements AppConstants.SharedConstants, AppConstants.urlConstants, ResponseListener, StatusChangedListener, SwipeRefreshLayout.OnRefreshListener, ItemDelete, myinter,getback {

    public static StatusChangedListener statusChangedListener = null;
    private RecyclerView mRecyclerViewNotificationList;
    private LinearLayoutManager manager = null;
    private PastNotificationHeaderAdapter mAdapter;
 ...
 public static getback getback;
    public Pastnotifiationfragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_pastnotifiactionfragment, container, false);
        Utility.setScreenTracking(getActivity(), AppConstants.SCREEN_TRACKING_ID_NOTIFICATION);
        getback=(getback)this;
    ...
    public void setNotificationAdapter() {
        mAdapter = new PastNotificationHeaderAdapter(getActivity(), items, this, this);
