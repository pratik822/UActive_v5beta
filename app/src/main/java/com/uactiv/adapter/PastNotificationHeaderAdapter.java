 ...
 */
public class PastNotificationHeaderAdapter extends NotificationStickyBaseAdapter implements StickyRecyclerHeadersAdapter<RecyclerView.ViewHolder>, AppConstants.urlConstants, AppConstants.SharedConstants, ResponseListener {
    ...
    private Pastnotifiationfragment mNotification_Fragment;
    MessageDatabaseService messageDatabaseService;

    public PastNotificationHeaderAdapter(Context context, ArrayList<NotifyModel> notifyModelArrayList, ItemDelete itemDelete, Pastnotifiationfragment mNotification_Fragment) {
    ...
    private void showTutorials() {
        ...
        new MaterialShowcaseView.Builder((Activity) mContext)
                ...
                .setTarget(tempItemViewHolder.itemView.findViewById(R.id.parentLayout))
    ...
    public void showFavTutorial() {
        ShowcaseView mShowcaseViewCreatePickup = new ShowcaseView.Builder((Activity) mContext)
                .setTarget(new ViewTarget(tempItemViewHolder.itemView.findViewById(R.id.detailsLayout)))
                .setContentText(mContext.getString(R.string.tutorial_msg_view_activity_details))
                .setContentTextPaint(Utility.getTextPaint(mContext))
