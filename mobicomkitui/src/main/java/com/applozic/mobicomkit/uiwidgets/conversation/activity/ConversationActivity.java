...
public class ConversationActivity extends AppCompatActivity implements MessageCommunicator, MobiComKitActivityInterface, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public static final String TAKE_CHAT = "takechat";
    ...
    /**
     * true block (disable textbox)
     * false allow chat ( show textbox )
     */

    public static boolean TAKE_CHAT_ALLOW = false;
    ...
    public boolean onSupportNavigateUp() {
        if (getSupportFragmentManager().getBackStackEntryCount() > 0) {
            ...
            Log.e("xcall", "onbackpress" + takeOrder);
           /* if (takeOrder) {*/
            this.finish();
           /* } else {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            if (getIntent().getBooleanExtra(ConversationActivity.TAKE_CHAT, false))
                TAKE_CHAT_ALLOW = true;
            else
                TAKE_CHAT_ALLOW = false;
        } else {
   ...
   /* @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.start_new) {
            ...
            Log.e("shareOptions","shareOptions");
