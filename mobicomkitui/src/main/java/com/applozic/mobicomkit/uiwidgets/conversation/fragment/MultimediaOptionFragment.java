            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                        ...
                        if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                            ...
                            if (photoFile != null) {
                                ...
                                ConversationActivity.setCapturedImageUri(capturedImageUri);
                                    ...
                                    ((MobiComKitActivityInterface) getActivity()).setCapturedImageUris(capturedImageUri);
                    ...
                    case 3:
                        ...
                        ((MobiComKitActivityInterface) getActivity()).showAudioRecordingDialog();
                        break;
                    case 4:
                        ...
                        if(getActivity() instanceof ConversationActivity) ((ConversationActivity) (getActivity())).setVideoFileUri(Uri.fromFile(fileUri));
                        else ((MobiComKitActivityInterface) (getActivity())).setVideoFileUri(Uri.fromFile(fileUri));
