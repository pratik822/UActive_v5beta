...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        mDismissButton.setBackgroundColor(Color.parseColor("#49DDA7"));
    ...
    private void setDismissTextSize(float size){
        if (mDismissButton != null) {
    ...
    public static class Builder {
        ...
        public Builder setTextTypeface(Typeface typeface) {
            showcaseView.setTypeface(typeface);
            return this;
        }
        ...
        public Builder setDismissTextSize(float size) {
            showcaseView.setDismissTextSize(size);
            return this;
        }
