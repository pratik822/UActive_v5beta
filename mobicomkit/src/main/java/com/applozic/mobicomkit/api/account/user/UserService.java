...
public class UserService {
    ...
    public ApiResponse  updateDisplayNameORImageLink( String displayName, String profileImageLink, String localURL, String status ){
        ...
        if(response != null && response.isSuccess()){
            ...
            Log.i("UserService", contact.getImageURL() + ", " +contact.getDisplayName() );
            ...
            Log.i("UserService", contact1.getImageURL() + ", " +contact1.getDisplayName() );
        }
        return response;
    }
